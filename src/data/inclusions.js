// ---------------------------------------------------------------------------
//  What's included.  `icon` maps to a key in components/icons.jsx.
// ---------------------------------------------------------------------------

// Short strip shown on the homepage under the hero
export const inclusionsStrip = [
  { icon: 'car', label: 'Pickup included' },
  { icon: 'plate', label: 'Food & drinks' },
  { icon: 'mask', label: 'Snorkelling gear' },
  { icon: 'towel', label: 'Towels' },
  { icon: 'lock', label: 'Private trips only' },
  { icon: 'tag', label: 'No hidden fees' },
]

// Fuller checklist for the all-inclusive promise section
...
export const noExtras = [
  'No surprise fees',
  'No awkward add-ons',
  'No photographer pressure',
  'No tourist-trap extras',
  'No shared groups',
  'No fixed timetable',
]
