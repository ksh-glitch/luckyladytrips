  ...
  "hurghada-private-boat-trips": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Prices start from EUR 250 for the speedboat, EUR 300 for One Lucky Lady and EUR 115 per person (minimum 4 guests) for the Locke Catamaran, with every trip starting at 4 hours. The price you see is the price you pay. No surprise add-ons, no photographer pressure, no extras sprung on you at sea."
      },
      {
  ...
  "soma-bay-snorkelling-trips": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Private day trips start from EUR 300 on One Lucky Lady, with the speedboat from EUR 250 and the Locke Catamaran for larger groups from EUR 115 per person (minimum 4 guests). Every trip starts at 4 hours. The price you see is the price you pay: pickup, food, drinks, gear and crew included. Message us on WhatsApp with your dates and group size to check availability."
      }
    ],
    "cta": {
  ...
  "private-yacht-charter-soma-bay": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "One Lucky Lady is the original private Red Sea escape, sized for 4 to 6 guests and made for couples, families and slow snorkelling days, from EUR 300. The Locke Catamaran takes up to 14 guests across four cabins, stable and roomy for groups, celebrations and overnight escapes, from EUR 115 per person with a minimum of four. The Private Speedboat is fast and private, built for fishing, quick escapes and snorkelling stops, from EUR 250.\n\nWhichever you pick, the standard holds. Hotel pickup and drop-off, food, drinks, snorkelling gear, towels, fuel and a full crew, all included. The price you see is the price you pay."
      },
      {
